...
/* harmony default export */ __webpack_exports__["default"] = (getRandomNumber);
...
/* harmony default export */ __webpack_exports__["default"] = (getRandomDecimal);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getrandomdecimal_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getrandomnumber_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__logb_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__logb_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__logb_js__);
...
function getRandomLowNumber(min=0, max=100, factor=0.9) {
	var base = 1.0 / factor;
		...
		var rndnum = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__getrandomnumber_js__["default"])(1, evtcnt);
		var expflr = Math.floor(__WEBPACK_IMPORTED_MODULE_2__logb_js___default()((rndnum-1) * (base-1) + 1, base));
		var rndres = max - expflr + min;
        return rndres;
}
/* harmony default export */ __webpack_exports__["default"] = (getRandomLowNumber);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__connection_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions_isnumber_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__functions_getrandomnumber_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__functions_getrandomdecimal_js__ = __webpack_require__(1);
...
class Neuron {
  constructor(brain, type) {
    ...
    this.connections = {};
    this.recentCharges = [];
    this.memory = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__["default"])(1, 10, 0.5);
    //console.log('Memory', this.memory)
    for (let i = 0; i < this.memory; i++){
      this.recentCharges.push(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__functions_getrandomdecimal_js__["default"])(0, 1));
    }
    this.polarization = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__functions_getrandomdecimal_js__["default"])(0, 1);
    this.depolarizationRate = 0.1;
    this.chargeRate = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__functions_getrandomdecimal_js__["default"])(0, 1);
    this.threshold = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__["default"])(1, 10);
    this.inverse = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__functions_getrandomnumber_js__["default"])(0, 1);
    this.bias = null;
    this.recentCharge = null;
    this.bindMethods(this);
    var initialChildrenCount = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__["default"])(1, Object.keys(this.brain.globalReferenceNeurons).length, 0.65);
...
/* harmony default export */ __webpack_exports__["default"] = (Neuron);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__neuron_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions_mutate_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions_mutate_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__functions_mutate_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__functions_getrandomnumber_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__functions_createstructure_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__functions_createstructure_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__functions_createstructure_js__);
...
for (let i = 1; i < times; i++) {
  var number = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__["default"])(1, 100, 0.5);
...
class Brain {
  constructor(inputSize, outputSize) {
    ...
    for (let i1 = 0; i1 < outputSize; i1++) {
      new __WEBPACK_IMPORTED_MODULE_0__neuron_js__["default"](this, 'output');
    }
    for (let i1 = 0; i1 < __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__["default"])(Math.round((inputSize + outputSize) / 4), Math.round((inputSize + outputSize) / 2)); i1++) {
      new __WEBPACK_IMPORTED_MODULE_0__neuron_js__["default"](this, 'hidden');
    }
    for (let i1 = 0; i1 < inputSize; i1++) {
      new __WEBPACK_IMPORTED_MODULE_0__neuron_js__["default"](this, 'input');
    }
    ...
    function create(brain, type, count, max) {
      if (count < max) {
        count++;
        new __WEBPACK_IMPORTED_MODULE_0__neuron_js__["default"](brain, type);
  ...
  generate() {
    ...
    this.mutationRate = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__functions_getrandomlownumber_js__["default"])(1, 100, 0.75); //change the max to be based on the current complexity of the network
    //console.log('New mutation rate: ', this.mutationRate);
    //console.log(this.mutationRate);
    __WEBPACK_IMPORTED_MODULE_1__functions_mutate_js___default()(this.mutationRate, this);
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__functions_getrandomnumber_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions_getrandomlownumber_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__functions_getrandomdecimal_js__ = __webpack_require__(1);
  ...
  constructor(brain, source, target) {
    if (typeof target == 'object' && target.constructor.name == 'Neuron' && typeof source == 'object' && source.constructor.name == 'Neuron' && brain.constructor.name == 'Brain') {
      if (!(source.type == 'input' && target.type == 'input') && !(source.type == 'output' && target.type == 'output') && target.id != source.id && source.type != 'output') {
        ...
        this.active = true;
        this.id = brain.counter;
        this.bias = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__functions_getrandomdecimal_js__["default"])(0, 1);
        this.source = source;
        this.target = target;
        this.recentCharges = [];
        this.memory = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__functions_getrandomlownumber_js__["default"])(1, 10, 0.5);
        //console.log(this.memory)
        for (let i = 0; i < this.memory; i++) {
          this.recentCharges.push(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__functions_getrandomdecimal_js__["default"])(0, 1));
        }
        this.deresistanceRate = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__functions_getrandomdecimal_js__["default"])(0, 1);
        this.resistanceGain = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__functions_getrandomdecimal_js__["default"])(0, 0.001, 0.5);
        this.resistance = 0;
        this.energy = 100;
        this.lastTime = 0;
        this.lastCharge = null;
        this.inverse = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__functions_getrandomnumber_js__["default"])(0, 1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__engine_entity_js__ = __webpack_require__(16);


function Engine(run, child, tick, targetScore, maxGens, surroundings, self, bounds, width, height, target, viewer) {
	var generationCount = 0;
	var entity = new __WEBPACK_IMPORTED_MODULE_0__engine_entity_js__["a" /* default */](run, surroundings, self, target, viewer);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__viewer_drawnode_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__viewer_drawlink_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__engine_findnewpoint_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__source_functions_getrandomnumber_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__viewer_rendernerve_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__viewer_renderobject_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__viewer_renderline_js__ = __webpack_require__(21);
...
class Viewer {
  ...
  render(entity, surroundings, target) {
    ...
    for (let i = 0; i < points.length; i++) {
      ...
      var p2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__engine_findnewpoint_js__["a" /* default */])(self.location.x, self.location.y, angle, self.radius);
      var p3 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__engine_findnewpoint_js__["a" /* default */])(p2.x, p2.y, angle, entity.nerves[i].size);
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__viewer_renderobject_js__["a" /* default */])(linkContext, points[i], false, false, borderColor);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__viewer_renderline_js__["a" /* default */])(underLinkContext, p3, points[i].location, linkColor, offsetX, offsetY);
    }

    // SIM CANVAS RENDERING

    for (var i1 = 0; i1 < surroundings.length; i1++) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__viewer_renderobject_js__["a" /* default */])(simContext, surroundings[i1]);
    }
    for (let i1 in entity.nerves) {
      var angle = (360 / entity.nerveCount) * i1;
      var p1 = self.location;
      var p2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__engine_findnewpoint_js__["a" /* default */])(self.location.x, self.location.y, angle, self.radius);
      var p3 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__engine_findnewpoint_js__["a" /* default */])(p2.x, p2.y, angle, entity.nerves[i1].size);

      entity.nerves[i1].points = [p2, p3];
      //console.log('Nerves', entity.nerves[i1])
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__viewer_rendernerve_js__["a" /* default */])(simContext, entity.nerves[i1]);
      var sourcePoint = {
        location: {
          x: p3.x,
          y: p3.y
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__viewer_renderobject_js__["a" /* default */])(linkContext, sourcePoint, offsetX, offsetY, linkColor);
    }
    //console.log(self);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__viewer_renderobject_js__["a" /* default */])(simContext, self);
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__viewer_renderobject_js__["a" /* default */])(simContext, target);
    ...
    if (!this.map) {
      ...
      Object.values(this.brain.layers.hidden).forEach((hiddenNeuron, index, hiddenArray) => {
        this.map[hiddenNeuron.id] = {
          x: (padding * 4) + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__source_functions_getrandomnumber_js__["default"])(0, width - (padding * 8)),
          y: (padding * 4) + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__source_functions_getrandomnumber_js__["default"])(0, height - (padding * 8))
        }
      });
    ...
    Object.values(this.brain.layers.input).forEach((inputNeuron, index, inputArray) => {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__viewer_renderline_js__["a" /* default */])(underLinkContext, this.map[inputNeuron.id], points[index].location, linkColor, offsetXAlt, offsetYAlt);
    ...
    for (let prop1 in this.brain.globalReferenceConnections) {
      ...
      if (connection.hasOwnProperty('source') && connection.hasOwnProperty('target') && typeof connection.source == 'object' && connection.source.constructor.name == 'Neuron' && typeof connection.target == 'object' && connection.target.constructor.name == 'Neuron') {
        ...
        if (this.map[connection.source.id] && this.map[connection.target.id]) {
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__viewer_drawlink_js__["a" /* default */])(this.map[connection.source.id].x, this.map[connection.source.id].y, this.map[connection.target.id].x, this.map[connection.target.id].y, brainContext, connection);
        }
      } else {
    ...
    for (var prop in this.map) {
      if (this.brain.globalReferenceNeurons[prop]) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__viewer_drawnode_js__["a" /* default */])(this.brain.globalReferenceNeurons[prop], brainContext, this.map[prop].x, this.map[prop].y, this.brain.globalReferenceNeurons[prop]);
      }
    }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__source_constructors_synapse_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__resources_engine_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__resources_viewer_js__ = __webpack_require__(11);
...
window.addEventListener("load", function() {
	...
	var viewer = new __WEBPACK_IMPORTED_MODULE_2__resources_viewer_js__["a" /* default */](canvas1, canvas2, canvas3, canvas4);
	var counter = 0;
	var network = new __WEBPACK_IMPORTED_MODULE_0__source_constructors_synapse_js__["a" /* default */](20, 2, async(run, child) => {
		viewer.update(child);
		...
		var engine = new __WEBPACK_IMPORTED_MODULE_1__resources_engine_js__["a" /* default */](run, child, 1, 0, 10000, surroundings, self, bounds, width, height, target, viewer);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__findnewpoint_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__entity_interceptoncircle_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__entity_linesegmentintersection_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__getdistance_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__interceptcircles_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__circleinbounds_js__ = __webpack_require__(14);
...
class Entity {
  constructor(run, surroundings, self, target, viewer) {
    ...
    for (var i1 = 0; i1 < this.nerveCount; i1++) {
      ...
      var p1 = self.location;
      var p2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__findnewpoint_js__["a" /* default */])(self.location.x, self.location.y, angle, self.radius);
      var p3 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__findnewpoint_js__["a" /* default */])(p2.x, p2.y, angle, this.nerveLength);
      var nerve = {
        points: [p2, p3],
  ...
  think(bounds, width, height, time, child) {
    ...
    for (var i1 = 0; i1 < this.nerveCount; i1++) {
      ...
      var p2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__findnewpoint_js__["a" /* default */])(this.self.location.x, this.self.location.y, angle, this.self.radius);
      var p3 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__findnewpoint_js__["a" /* default */])(p2.x, p2.y, angle, this.nerveLength);
      var nerve = {
        points: [p2, p3],
        size: 50 //this.nerveLength
    ...
    for (var i1 = 0; i1 < this.nerveCount; i1++) {
      var lineCollisions = bounds.map(bound => {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__entity_linesegmentintersection_js__["a" /* default */])(this.nerves[i1].points, bound);
      }).filter(distance => {
        return distance && distance < 50;
      });
      var circleCollisions = this.surroundings.map(obstacle => {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__entity_interceptoncircle_js__["a" /* default */])(this.nerves[i1].points[0], this.nerves[i1].points[1], obstacle.location, obstacle.radius);
      }).filter(distance => {
        return distance && distance < 50;
      });
    ...
    */
    ...
    var distanceFromTarget = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__getdistance_js__["a" /* default */])(this.self.location, this.target.location);
    var distanceFromStart = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__getdistance_js__["a" /* default */])(this.origin, this.self.location);
    ...
    for (var i1 = 0; i1 < surroundings.length; i1++) {
      if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__interceptcircles_js__["a" /* default */])(this.self, this.surroundings[i1])) {
        result.state = 'complete';
      }
    }
    if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__interceptcircles_js__["a" /* default */])(this.self, this.target)) {
      result.state = 'complete';
    }
    if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__circleinbounds_js__["a" /* default */])(width, height, this.self)) {
      result.state = 'complete';
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getdistance_js__ = __webpack_require__(5);
...
function lineSegmentIntersection(line1, line2) {
	...
	if (s >= 0 && s <= 1 && t >= 0 && t <= 1) {
		...
		var distance = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__getdistance_js__["a" /* default */])(line1[0], collision);
		return distance;
	} else {
		return null;
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__source_functions_getrandomnumber_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__drawlink_js__ = __webpack_require__(6);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__brain_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions_clonebrain_js__ = __webpack_require__(28);
...
class Synapse {
  constructor(inputSize, outputSize, runFunction) {
    ...
    this.brain = new __WEBPACK_IMPORTED_MODULE_0__brain_js__["a" /* default */](inputSize, outputSize);
  ...
  async initiate() {
    ...
    if (this.child) {
      this.child = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__functions_clonebrain_js__["a" /* default */])(this.brain);
      this.child.generate();
    } else {
      var newChild = null;
      for (let i = 0; i < 100; i++) {
    ...
    if (childScore === false) {
      return this.brain;
    } else if (childScore instanceof __WEBPACK_IMPORTED_MODULE_0__brain_js__["a" /* default */]) {
  ...
  async getScoredChild() {
    var child = new __WEBPACK_IMPORTED_MODULE_0__brain_js__["a" /* default */](this.inputSize, this.outputSize);
    child.generate();
    child = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__functions_clonebrain_js__["a" /* default */])(child);
...
/* harmony default export */ __webpack_exports__["a"] = (Synapse);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__clonebrainproperty_js__ = __webpack_require__(29);


function cloneBrain(brain) {
	//console.log('Source Brain: ', brain);
	var clone = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__clonebrainproperty_js__["a" /* default */])(brain);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constructors_connection_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constructors_neuron_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constructors_brain_js__ = __webpack_require__(7);
...
var cloneBrainProperty = function clone(sourceProperty, clonedBrain = null) {
    ...
    if (sourceProperty instanceof __WEBPACK_IMPORTED_MODULE_2__constructors_brain_js__["a" /* default */]) {
        if (clonedBrain == null) {
            clonedProperty = new __WEBPACK_IMPORTED_MODULE_2__constructors_brain_js__["a" /* default */](sourceProperty.inputSize, sourceProperty.outputSize);
            clonedBrain = clonedProperty;
        } else {
            clonedProperty = clonedBrain;
        }
    } else if (sourceProperty instanceof __WEBPACK_IMPORTED_MODULE_1__constructors_neuron_js__["default"]) {
        if (!neurons[sourceProperty.id]) {
            clonedProperty = new __WEBPACK_IMPORTED_MODULE_1__constructors_neuron_js__["default"](clonedBrain, sourceProperty.type);
            neurons[sourceProperty.id] = clonedProperty;
        } else {
            clonedProperty = neurons[sourceProperty.id];
        }
    } else if (sourceProperty instanceof __WEBPACK_IMPORTED_MODULE_0__constructors_connection_js__["a" /* default */]) {
        if (!neurons[sourceProperty.id]) {
            clonedProperty = new __WEBPACK_IMPORTED_MODULE_0__constructors_connection_js__["a" /* default */](clonedBrain, sourceProperty.source, sourceProperty.target);
            connections[sourceProperty.id] = clonedProperty;
        } else {
            clonedProperty = connections[sourceProperty.id];
        }
    }
    if (typeof sourceProperty == 'object' && (!(sourceProperty instanceof __WEBPACK_IMPORTED_MODULE_2__constructors_brain_js__["a" /* default */]) || clonedBrain == null)) {
...
const mutations = __webpack_require__(34);
const getRandomNumber = __webpack_require__(0);
const getRandomProperty = __webpack_require__(9);
var mutationList = [];
...
const getRandomProperty = __webpack_require__(9);
const getRandomNumber = __webpack_require__(0);
const getRandomDecimal = __webpack_require__(1);
const getRandomLowNumber = __webpack_require__(2);
